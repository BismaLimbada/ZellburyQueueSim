...
public class SimulationEngine
{
    ...
    public SimulationResult Run()
    {
        ...
        var systemTrace = new List<QueueLengthSample> { new(0, 0) };
        ...
        while (!fel.IsEmpty)
        {
            ...
            if (evt.Type == EventType.Arrival)
            {
                ...
                systemTrace.Add(new QueueLengthSample(clock, waitingQueue.Count + (serverBusy ? 1 : 0)));
