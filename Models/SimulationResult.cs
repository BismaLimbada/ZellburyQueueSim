...
public class SimulationResult
{
    ...
    /// <summary>Number of customers in the whole system (waiting + the one being served) at each event, for the "queue+service" step chart.</summary>
    public List<QueueLengthSample> SystemLengthTrace { get; set; } = new();
